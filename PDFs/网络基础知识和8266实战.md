本讲义由[Lucas-Song (Lucas Song)](https://github.com/Lucas-Song-zero)在2025/6/27在 [Obsidian](https://obsidian.md/)中完成。结合Table of Contents、Better ExportPDF插件和Advanced Tables插件。
...
本讲义中，我主要从硬设开发的角度出发，介绍如何使用ESP8266的WiFi or 蓝牙模块实现简单的IoT功能，让大家的作品可以更出彩。在此讲义的补充材料中，JWT同学则会给大家带来如何使用树莓派部署属于自己的网页的教程（敬请期待）。
